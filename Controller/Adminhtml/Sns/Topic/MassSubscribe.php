 ...
 * Class MassSubscribe
 */
class MassSubscribe extends \Magento\Backend\App\Action
{
    /**
     * @var Filter
     */
    ...
    public function execute()
    {
        ...
        foreach ($collection as $topic) {
            $this->_sns->subscribe($topic->getArn());
        }

        $this->messageManager->addSuccess(__('A total of %1 topic(s) have been subscribed to.', $collectionSize));
